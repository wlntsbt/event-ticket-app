        ...
        <Form>
          <div className="flex flex-col items-end gap-6">
            <div className="relative h-10 w-full min-w-[200px]">
              ...
              rounded-[7px]
              border border-black
              bg-transparent px-3 py-2.5 text-md font-normal text-black outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-black focus:border-2 focus:border-purple-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-gray-500"
                placeholder=" "
              />
              <label
